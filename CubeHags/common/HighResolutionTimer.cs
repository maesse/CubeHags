...
namespace CubeHags.client
{
    ...
    public sealed class HighResolutionTimer
    {
        ...
        {
            return (float)(HighResolutionTimer.Ticks - _startTime) / (float)(Frequency / 1000f); // return ms
        }
        ...
        public void Set()
        {
            ...
            _frameTime = (float)(endTime - _fpsstartTime) / (float)HighResolutionTimer.Frequency;
            _fpsstartTime = endTime;
